...
matching xxx-xxx-xxxx using sequencing, repeaters, escaped characters
:::
...
The power and ease of the command line...

Using an appropriate grep, find the secret message hidden in *some* of the files in the zip folder:
